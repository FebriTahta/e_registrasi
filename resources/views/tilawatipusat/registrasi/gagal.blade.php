	        ...
	        <div class="col-xl-4 col-lg-4 content-left">
	            <div class="content-left-wrapper">
	                ...
	                <div><?php date_default_timezone_set('Asia/Jakarta'); $date=$diklat->tanggal;?>
	                    ...
	                    <a href="#0" class="btn_1 rounded yellow">Perbarui Data!</a>
	                    <a href="#start" class="btn_1 rounded mobile_btn yellow">Perbarui Data!</a>
	                </div>
	            ...
	            <div id="wizard_container">
	                <div>
						...
						<div class="form-group text-center">
							<p>Pendaftaran Gagal!  </p><span> Periksa pesan whatsapp terkait alasan gagalnya pendaftaran yang dikirimkan ke nomor  <b>{{$peserta->telp}}</b> </span><br><br>
                            <p>Silahkan perbarui data anda dengan benar pada tombol yang tertera diatas</p>
						</div>
	                </div>
	                <!-- /top-wizard -->
	            </div>
