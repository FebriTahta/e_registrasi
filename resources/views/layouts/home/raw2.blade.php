...
<head>
  ...
  ================================================== -->
	...
	<link rel="stylesheet" href="{{ asset('registrasi/css/colorbox.css') }}"/>
...
<body>	
	...
	<div class="header-top">
		...
		<header class="cd-main-header">
			<a class="cd-logo animsition-link" href="/"><img src="{{ asset('images/nf_logo.png') }}" alt="Logo"></a>
					...
					<div class="tp-banner" >
						<ul>
							{{-- <li data-transition="fade" data-slotamount="1" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
								...
								<img src="{{ asset('registrasi/home2.jpg') }}"  alt="slidebg1" data-lazyload="{{ asset('registrasi/home2.jpg') }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								
									<div class="tp-caption black-big randomrotate tp-resizeme rs-parallaxlevel-10"
										data-x="10"
										data-y="170"
										data-speed="500"
										data-start="700"
									...
									<div class="tp-caption color-big randomrotate tp-resizeme rs-parallaxlevel-7"
										data-x="50"
										data-y="370"
										data-speed="500"
										data-start="900"
									...
									<div class="tp-caption black-big randomrotate tp-resizeme rs-parallaxlevel-4"
										data-x="210"
										data-y="230"
										data-speed="500"
										data-start="1100"
									...
									<div class="tp-caption black-big randomrotate tp-resizeme rs-parallaxlevel-2"
										data-x="280"
										data-y="490"
										data-speed="500"
										data-start="1300"
										...
										data-elementdelay="0.1"
										data-endelementdelay="0.1"
										style="z-index: 300; max-width: auto; max-height: auto; white-space: nowrap;">
										A
									</div>
									<div class="tp-caption color-big randomrotate tp-resizeme rs-parallaxlevel-1"
										data-x="450"
										data-y="410"
										data-speed="500"
										data-start="1500"
									...
									<div class="tp-caption black-big randomrotate tp-resizeme rs-parallaxlevel-3"
										data-x="780"
										data-y="220"
										data-speed="500"
										data-start="1900"
									...
									<div class="tp-caption black-big randomrotate tp-resizeme rs-parallaxlevel-7"
										data-x="940"
										data-y="510"
										data-speed="500"
										data-start="2300"
									...
									<div class="tp-caption sfb ltl tp-resizeme"
										...
										<img src="{{ asset('registrasi/images/iphone.png') }}" alt="">
									</div>							

							</li> --}}
							<li data-transition="fade" data-slotamount="1" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
								<img src="{{ asset('registrasi/home4.jpg') }}"  alt="slidebg2" data-lazyload="{{ asset('registrasi/home4.jpg') }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
									<div class="tp-caption black-heavy-2 randomrotate tp-resizeme"
										...
										data-endelementdelay="0.1"
										style="z-index: 500; max-width: auto; max-height: auto; white-space: nowrap;">
										<span class="slider-text-color" ></span>
									</div>
									<div class="tp-caption black-small randomrotate tp-resizeme"
										...
										data-elementdelay="0.1"
										data-endelementdelay="0.1"
										style="z-index: 800; max-width: auto; max-height: auto; white-space: nowrap;">
										{{-- GABISA DITURUNIN --}}
									</div>
								{{-- <a href="#"><div class="button-slider">Procedure</div></a>	 --}}
							</li>
						</ul>
					</div>
				</div>
        ...
        <div class="container">
            <div class="sixteen columns">
                <div class="section-title">
                    ...
                    {{-- <div class="subtitle">Pastikan anda melakukan<span class="subtitle-written"> seluruh tahapan</span> dalam pendaftaran diklat</div> --}}
                </div>
            </div>
            <div class="sixteen columns">
                <center>
                    <img class="img-prosedur img-responsive" src="https://ditpdpontren.kemenag.go.id/daftarkeberadaanpesantren/front/img/prosedur.png" alt="Prosedur">
                </center>
            </div>
        </div>
    </section>
    ...
    {{-- <section id="prosedur">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading title-prosedur">PROSEDUR</h2>
                <p class="section-subheading text-muted"><br>
                    <img class="img-prosedur img-responsive" src="https://ditpdpontren.kemenag.go.id/daftarkeberadaanpesantren/front/img/prosedur.png" alt="Prosedur">
            </p></div>
        </div>
    </section> --}}
...
{{-- <script type="text/javascript" src="{{ asset('registrasi/js/smoothScroll.js') }}"></script> --}}
<script type="text/javascript" src="{{ asset('registrasi/js/isotope.js') }}"></script> 
...
<script type="text/javascript" src="{{ asset('registrasi/js/jquery.colorbox.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('registrasi/js/custom-portfolio-home-1.js') }}"></script>  	  
<!-- End Document
================================================== -->
</body>
</html>