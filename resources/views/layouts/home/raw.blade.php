					...
					<div class="tp-banner" >
						<ul>
							<li data-transition="fade" data-slotamount="1" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
								...
								<img src="{{ asset('registrasi/images/1.jpg') }}"  alt="slidebg1" data-lazyload="{{ asset('registrasi/images/1.jpg') }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
							...
							<li data-transition="fade" data-slotamount="1" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
								...
								<img src="{{ asset('registrasi/images/2.jpg') }}"  alt="slidebg2" data-lazyload="{{ asset('registrasi/images/2.jpg') }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
