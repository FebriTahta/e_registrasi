                ...
                <form action="{{route('registrasi')}}" method="POST" enctype="multipart/form-data"> @csrf
                    ...
                    <div class="row" id="id">
                        ...
                        <div class="form-group col-12 col-xl-12">
                            ...
                            <textarea name="alamatx" id="alamatx" cols="30" rows="3" class="form-control" >Nama Jalan :... Nomor Rumah / Lokasi Pengiriman Modul :... RT :... RW :... Kecamatan :... Kabupaten / Kota :...</textarea>
                        </div>
                        @endif
                    </div>
