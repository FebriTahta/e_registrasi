        ...
        @else
            ...
            @if ($diklat->pendaftaran !== 'ditutup')
                ...
                <div class="card text-left" style="width: 650px; max-width: 100%; padding: 15px;">
                    ...
                    <div class="text-center" style="text-align: center">
                        <a target="_blank" href="https://help.tilawatipusat.com/artikel/panduan-pendaftaran-program-diklat-online" class="btn btn-sm btn-outline-primary">Panduan Pengisian Form Pendaftaran</a>
                    </div>
                    <form action="{{route('registrasi')}}" method="POST" enctype="multipart/form-data"> @csrf
                        ...
                        <div class="row" id="id">
                            ...
                            <div class="form-group col-12 col-xl-12">
                                ...
                                <textarea name="alamatx" id="alamatx" cols="30" rows="3" class="form-control" >Tulis lokasi alamat pengiriman modul (buku) dengan jelas</textarea>
                            </div>
                            @endif
                        </div>
            ...
            @else
                ...
                <div class="card text-center" style="width: 650px; max-width: 100%; padding: 15px;">
                    <h5 class="text-danger"> PENDAFTARAN UNTUK DIKLAT INI SUDAH DITUTUP :)</h5>
                </div>
            @endif
