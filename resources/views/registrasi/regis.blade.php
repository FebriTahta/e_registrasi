            ...
            <div class="card text-left" style="width: 650px; max-width: 100%; padding: 15px;">
                <form action="{{route('registrasi')}}" method="POST" enctype="multipart/form-data"> @csrf
                    ...
                    <div class="row" id="id">
                        ...
                        @if ($diklat->program->name == "standarisasi guru al qur'an level 1" || $diklat->program->name == "standarisasi guru al qur'an level 2")
                        <div class="form-group col-12 col-xl-12">
                            <label for="alamatx"><i class="text-danger">*</i> Alamat Lengkap (Untuk Pengiriman Modul)</label>
                    ...
                    <div class="form-group text-right">
                        <input type="submit" id="daftar" onclick="var e=this;setTimeout(function(){e.disabled=true;},0);return true;" class="btn btn-sm btn-success" value="Daftar!">
                    </div>
                </form>
            </div>
        @endif
