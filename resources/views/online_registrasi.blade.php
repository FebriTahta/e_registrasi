                ...
                <div id="middle-wizard">
							...
							<div class="col-md-12">
								<div class="list_block">
									<ul>
										<li>
											<div class="checkbox_radio_container">
												<input type="text" id="asal_cabang" placeholder="Cahaya Amanah - Surabaya" name="asal_cabang" class="form-control required" style="text-transform: uppercase" required>
											</div>
										</li>
									</ul>
								</div>
                    ...
                    <div class="step">
                        ...
                        <div class="row">
							...
							<hr>
							<small for="" style="color: red">Isi Tempat Lahir Alternatif apabila tempat lahir anda tidak ada pada list diatas. Jika ada Kosongi Kolom ini</small>
							<div class="form-floating col-md-12" style="margin-bottom: 10px">
