                            ...
                            <div id="middle-wizard">
                                <center style="padding: 3%;">
                                    ...
                                    <div class="card text-center" style="width: 650px; max-width: 100%; padding: 15px;">
                                        ...
                                        <span>Silahkan Bergabung Pada Group WA Berikut dengan Klik Tombol
                                            Bergabung</span>
                                        <br>
                            ...
                            <div id="middle-wizard">
                                ...
                                @if ($data->status == 0)
                                    <div class="konten ">
                                        ...
                                        <hr>
                                        <small>Terimakasih Telah Mendaftar. Anda Akan Menerima Pesan WhatsApp dari KAMI
                                            Setelah Data Anda Kami Verifikasi</small>
                                        <br>
                                        <small>Data Pendaftaran Anda Akan Segera Kami Proses</small><br>
                                        <small class="text-primary">Mohon Menunggu & Pastikan Nomor WhatsApp anda
                                            Aktif</small>
                                    </div><br>
                                    <div class="tombol">
                                        ...
                                        <a style="margin-bottom: 10px; width: 130px" class="btn_2 btn-sm"
                                            href="#popup2">PANDUAN</a>
                                        <a style="margin-bottom: 10px;" class="btn_1 btn-sm"
                                            href="#popup1">PEMBERITAHUAN</a>
                                        {{-- <a class="btn btn-sm btn-primary text-white" href="#modal-help2" id="modal_h2">Pemberitahuan</a> --}}
                                    </div>
                                @else
                                    <div class="konten">
                                        <small>Hai : {{ $data->name }}</small><br>
                                        <small>Anda Sudah Terdaftar dan Sudah Kami Kirimkan Notifikasi Melalui WhatsApp
                                            Anda. Jadi Mohon Periksa Pesan Dari Kami.</small>
                                        <br>
